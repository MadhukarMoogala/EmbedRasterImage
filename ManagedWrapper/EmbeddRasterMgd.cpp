...
using namespace ADN::CustomWrapper;

//-----------------------------------------------------------------------------
MyRasterImageDefMgd::MyRasterImageDefMgd() : 
	Autodesk::AutoCAD::DatabaseServices::RasterImageDef((System::IntPtr)new AcDbMyRasterImageDef(), true) {
}

//-----------------------------------------------------------------------------
MyRasterImageDefMgd::MyRasterImageDefMgd(System::IntPtr unmanagedPointer, bool bAutoDelete) : 
	Autodesk::AutoCAD::DatabaseServices::RasterImageDef(unmanagedPointer, bAutoDelete) {
}

void MyRasterImageDefMgd::SetEmbeddedImage(System::String^ imageFilePath) {
